...
// Precondición: Recibe un vector de estructuras tipo tPerfil, el cual, debería tener un tamaño mínimo, en caso de no tenerlo, llama a SignUp para crear un nuevo usuario.
...
// Precondición: recibe una cadena de caraacteres.
// Poscondición: elimina, si se encuentra, un salto de línea al final de la palabra
