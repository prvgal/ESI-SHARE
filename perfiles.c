    ...
    do{
        ...
        if(scanf("%i", &op) != 1){  // Con esta condición podemos evitar que el usuario haga una entrada errónea.
            ...
            switch(op){
                ...
                case 3: menuviajes(infoper[posUsua].Id_usuario, infoper[posUsua].Perfil_usuario, infoper[posUsua].Localidad); break;
...
static int SignUp(tPerfil *infoper){
    ...
    menu_registro_vehiculo(infoper[numPerfiles].Id_usuario);
